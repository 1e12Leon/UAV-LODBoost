...
if __name__ == "__main__":
    ...
    while Cur_Num < Out_Num:
        ...
        # 复制特定种类的小目标
        small_object_list, annots, image_small = get_small_object_list(line_2, is_special=True, cls=cls)
        ...
        if image_data is not None:
            ...
            img.save(os.path.join(Out_JPEGImages_path, str(Cur_Num) + '_SOA.jpg'))
            write_xml(os.path.join(Out_Annotations_path, str(Cur_Num) + '_SOA.xml'), os.path.join(Out_JPEGImages_path, str(Cur_Num) + '_SOA.jpg'), \
