...
if __name__ == "__main__":
    ...
    for index in range(Out_Num):
        ...
        img.save(os.path.join(Out_JPEGImages_path, str(index) + '_mixup.jpg'))
        write_xml(os.path.join(Out_Annotations_path, str(index) + '_mixup.xml'), os.path.join(Out_JPEGImages_path, str(index) + '_mixup.jpg'), \
