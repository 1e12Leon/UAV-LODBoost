...
def fit_one_epoch_distill(model_train, t_model_train, model, ema, yolo_loss, loss_history, eval_callback, optimizer, epoch, epoch_step,
    ...
    for iteration, batch in enumerate(gen):
        ...
        if not fp16:
            ...
            # distill_loss_value = yolo_loss(outputs, t_outputs, images)
            # loss_value += distill_loss_value
