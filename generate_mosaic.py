...
from my_utils.random_data import get_random_data, get_random_data_with_Mosaic
...
if __name__ == "__main__":
    ...
    for index in range(Out_Num):
        ...
        img.save(os.path.join(Out_JPEGImages_path, str(index) + '_mosaic.jpg'))
        write_xml(os.path.join(Out_Annotations_path, str(index) + '_mosaic.xml'), os.path.join(Out_JPEGImages_path, str(index) + '_mosaic.jpg'), \
